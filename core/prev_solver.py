...
class CaptioningSolver(object):
    def __init__(self, model, data, val_data, **kwargs):
        ...
        self.model_path = kwargs.pop('model_path', './prev_model/')
        ...
        with tf.Session(config=config) as sess:
            ...
            for e in range(self.n_epochs):
                ...
                if self.print_bleu:
                    ...
                    save_pickle(all_decoded, "../resized_training_data/prev_val/val.candidate.captions.pkl")
    ...
    def test(self, data, split='train', attention_visualization=True, save_sampled_captions=True):
        ...
        with tf.Session(config=config) as sess:
            ...
            if save_sampled_captions:
                ...
                save_pickle(all_decoded, "./resized_training_data/prev_%s/%s.candidate.captions.pkl" %(split,split))